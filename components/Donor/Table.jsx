...
const Table = () => {
  ...
  return (
    <div className="shadow-lg rounded-b-lg flex flex-col w-[100%] md:w-[100%] lg:w-[50%] items-center min-h-[50rem] h-max relative justify-center">
      ...
      <div className="w-full min-h-[45rem] ">
        ...
        <table className="w-[100%] mt-4 text-center font-[Poppins]" id="blood-group-info">
      ...
      <div className="flex bottom-0 mt-2 ml-[50%] ">
        <div>
          <button
