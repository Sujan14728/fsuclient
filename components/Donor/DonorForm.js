...
const DonorForm = () => {
  ...
  return (
    <div className="h-max w-[100%] lg:w-[50%] shadow-lg rounded-lg mt-14 mb-10 bg-[#fcfcfc] ">
      <form>
        <div className="flex justify-center ">
          <span className="font-bold text-2xl text-background-color font-[Montserrat] mt-6 ">
