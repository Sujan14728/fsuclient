  ...
  return (
    <div className="flex justify-center ">
      ...
      <motion.div
        ...
        className="flex flex-col text-white border-2 h-[38rem] w-[38rem] justify-center items-center shadow-lg rounded-lg z-20 
        bg-gradient-radial  from-[#1c327a,#1c327af8] to-[#12dee657]
        "
        // bg-gradient-to-tr from-[#ff0000c9] to-[#0c08f0cb]
      >
        <motion.div
        ...
        <p className="text-lg mb-10">Get access to the portal by signing in</p>
